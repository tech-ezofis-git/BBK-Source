        ...
        Public Function Upload(para As InsUpload) As HttpResponseMessage
            ...
            Try
                ...
                If SaveAPICallInput.ToLower = "yes" Then
                    ...
                    logf += " Entered jsonconvert before "
                ...
                End If
                logf += " step1.."
                Dim strqry = "insert into eZAPICallHistory (Template,CabinetId ,TemplateId ,Status,Remarks,[RIM Number],ItemId,ParentCallId ,APIFunction,XmlFileName,CreatedOn,UpdatedOn,CreatedBy,UpdatedBy,Isdeleted,inputJson ) values ('" + para.CabinetName + "',0,0,'Process','','',0,0,'Upload','','" + DateDateTimeToString(Date.Now, True) + "','',0,0,0,'" + inputJson.Replace("'", "''") + "')"
